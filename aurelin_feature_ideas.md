# Aurelin — Roadmap (FROZEN — build, don't re-plan)

**Positioning:** *Explainable Code Intelligence.* Not just scores — evidence, reasoning, and
prioritized improvements. Aurelin isn't "another AI analyzer," it's AI decision support:
Explainable Scoring → Confidence → Evidence → Root Cause → Sprint Plan.

**Suggested README opening line:** *"Aurelin is an explainable code intelligence platform
